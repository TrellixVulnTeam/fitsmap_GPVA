...
Supercluster.prototype.getClusters = function getClusters (bbox, zoom) {
    ...
    // custom crs x/y
        ...
        var maxLng$1 = bbox[2];
        var maxLat$1 = bbox[3];
        ids = tree.range(this.lngX(minLng$1), this.latY(minLat$1), this.lngX(maxLng$1), this.latY(maxLat$1));
    }
...
Supercluster.prototype.lngX = function lngX (lng) {
    return lng / 360 + 0.5;
};
Supercluster.prototype.latY = function latY (lat) {
...
Supercluster.prototype.xLng = function xLng (x) {
    return (x - 0.5) * 360;
};

Supercluster.prototype.yLat = function yLat (y) {
    var y2 = (180 - y * 360) * Math.PI / 180;
    return 360 * Math.atan(Math.exp(y2)) / Math.PI - 90;
};

Supercluster.prototype.createPointCluster = function createPointCluster (p, id) {
...
Supercluster.prototype.getClusterJSON = function getClusterJSON (cluster) {
    return {
        type: 'Feature',
        id: cluster.id,
